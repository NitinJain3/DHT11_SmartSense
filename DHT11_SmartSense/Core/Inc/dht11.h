 ...
 *
 * @param temp     Temperature integer value (from DHT11).
 * @param humidity Humidity integer value (from DHT11).
 * @return uint8_t Returns 1 if either temperature or humidity exceeds the threshold, otherwise 0.
 */
